...
import 'package:bungapads/userprofile.dart';
import 'package:bungapads/adminproduct.dart';
import 'package:bungapads/user.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  String server = "https://saujanaeclipse.com/bungabunga";
  ...
  void initState() {
    ...
    _loadData();
    _loadCartQuantity();
    if (widget.user.email == "admin@bungabunga.com") {
      _isadmin = true;
    }
  }
          ...
          floatingActionButton: FloatingActionButton.extended(
            onPressed: () async {
              if (widget.user.email == "unregistered") {
                ...
                return;
              } else if (widget.user.email == "admin@bungabunga.com") {
  ...
  _addtocartdialog(int index) {
    if (widget.user.email == "unregistered@bungabunga.com") {
      Toast.show("Please register to use this function", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    }
